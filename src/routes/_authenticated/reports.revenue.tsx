...
export const Route = createFileRoute("/_authenticated/reports/revenue")({
  head: () => ({
    meta: [
      { title: "Revenue Report | Transline Classic TMS" },
      { name: "description", content: "Combined ticket and parcel revenue trends." },
      { property: "og:title", content: "Revenue Report | Transline Classic TMS" },
      { property: "og:description", content: "Combined ticket and parcel revenue trends." },
    ],
  }),
...
function ReportsRevenuePage() {
  return (
    <Page title="Revenue Report" description="Combined ticket and parcel revenue trends.">
      <DemoNotice />
